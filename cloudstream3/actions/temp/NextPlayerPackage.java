...
@SourceDebugExtension(value={"SMAP\nNextPlayerPackage.kt\nKotlin\n*S Kotlin\n*F\n+ 1 NextPlayerPackage.kt\ncom/lagradost/cloudstream3/actions/temp/NextPlayerPackage\n+ 2 Uri.kt\nandroidx/core/net/UriKt\n*L\n1#1,35:1\n29#2:36\n*S KotlinDebug\n*F\n+ 1 NextPlayerPackage.kt\ncom/lagradost/cloudstream3/actions/temp/NextPlayerPackage\n*L\n31#1:36\n*E\n"})
public final class NextPlayerPackage
extends OpenInAppAction {
    @NotNull
    private final Set<ExtractorLinkType> sourceTypes;
    private final boolean oneSource;

    public NextPlayerPackage() {
        super(TextUtilKt.txt("NextPlayer"), "dev.anilbeesetti.nextplayer", "dev.anilbeesetti.nextplayer.feature.player.PlayerActivity", null, 8, null);
